...
public class GhostBox
{
    ...
    {   //Column 1
        ...
        { new Coordinate(3,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxCornerDownLeft) },
        { new Coordinate(3,4), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeLeft) },
        { new Coordinate(3,5), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeLeft) },
        { new Coordinate(3,6), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeLeft) },
        { new Coordinate(3,7), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxCornerUpLeft) },
        ...
        { new Coordinate(4,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeDown) },
        { new Coordinate(4,4), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(4,5), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(4,6), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(4,7), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeUp) },
        ...
        { new Coordinate(5,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeDown) },
        { new Coordinate(5,4), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(5,5), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(5,6), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(5,7), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostDoorConnectorRight) },
        ...
        { new Coordinate(6,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeDown) },
        { new Coordinate(6,4), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(6,5), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(6,6), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(6,7), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostDoor) },
        ...
        { new Coordinate(7,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeDown) },
        { new Coordinate(7,4), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(7,5), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(7,6), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        ...
        { new Coordinate(8,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeDown) },
        { new Coordinate(8,4), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(8,5), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(8,6), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(8,7), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostDoorConnectorLeft) },
        ...
        { new Coordinate(9,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeDown) },
        { new Coordinate(9,4), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(9,5), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(9,6), new Tuple<TileState, TileSprite>(TileState.Empty, TileSprite.Empty) },
        { new Coordinate(9,7), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeUp) },
        ...
        { new Coordinate(10,3), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxCornerDownRight) },
        { new Coordinate(10,4), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeRight) },
        { new Coordinate(10,5), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeRight) },
        { new Coordinate(10,6), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxEdgeRight) },
        { new Coordinate(10,7), new Tuple<TileState, TileSprite>(TileState.Occupied, TileSprite.GhostBoxCornerUpRight) },
